# Debian-Wayfire
Wayfire does not work out of box on Debiam 12. For some reason wf-shell is no where to be found in the repo, so it muct be downlaoded and compiled from source. This should get you started with a basic working install of Wayfire.
